{-# LANGUAGE FlexibleContexts, RankNTypes, ExistentialQuantification, GeneralizedNewtypeDeriving #-}
...
module Network.Discord.Types
  ...
  , module Data.Aeson
    ...
    class (MonadIO m, MonadPlus m, MonadBaseControl IO m) => DiscordAuth m where
      auth :: m Auth
      version :: m String
