...
module Network.Discord
  ...
  runBot :: (DiscordAuth m, EventHandler f m) => Proxy (m f) -> m ()
  runBot p = runGateway gatewayUrl $ (view _2 >>= go p) <|> return ()
    where
  ...
  instance (DiscordGate b m, DiscordRest m) => EventMap ReadyEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap ResumedEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap ChannelCreateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap ChannelUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap ChannelDeleteEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildCreateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildDeleteEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildBanAddEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildBanRemoveEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildEmojiUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildIntegrationsUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildMemberAddEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildMemberRemoveEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildMemberUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildMemberChunkEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildRoleCreateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildRoleUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap GuildRoleDeleteEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap MessageCreateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap MessageUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap MessageDeleteEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap MessageDeleteBulkEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap PresenceUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap TypingStartEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap UserSettingsUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap UserUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) =>  EventMap VoiceStateUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m) => EventMap VoiceServerUpdateEvent m where
  ...
  instance (DiscordGate b m, DiscordRest m, KnownSymbol e) => EventMap (OtherEvent e) m where
